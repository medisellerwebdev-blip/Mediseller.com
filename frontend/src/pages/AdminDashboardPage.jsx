                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-3">
                        <Button 
                          variant="outline" 
                          size="sm"
                          className="rounded-full h-9 border-primary/30 text-primary hover:bg-primary/5"
                        ...
                        <Badge className="bg-slate-100 text-slate-600 border-0 h-9 px-4">{orders.length} Total</Badge>
                    </div>
                  </div>
                </CardHeader>
